...
module.exports = (() => {
    ...
    const BetterSyntaxCSS = `@import url("https://fonts.googleapis.com/css2?family=Source Code Pro:wght@550&display=swap");.bettersyntax-tip{margin-bottom:10px;}code{font-family:"Source Code Pro"}.hljs{box-shadow: 2px 3px 10px 0px #00000057;border-radius:4px;margin-bottom:10px !important;border: none !important;} .hljs.collapsed {min-height: 28px; max-height: 28px; font-size: 0;display: flex;} .hljs.collapsed .bettersyntax-buttons {margin-right: 7px;margin-top: 6px;pointer-events: all;top: 10px;} .hljs.collapsed::before {content: "Collapsed codeblock";width: 76%;height: 28px;text-align: center;font-size: 10pt;position: absolute;padding-top: 5.5px;font-family: var(--font-primary);font-weight: 500;}`;
